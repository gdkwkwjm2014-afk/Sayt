#define IMGUI_DISABLE_OBSOLETE_FUNCTIONS // Тот самый важный нюанс!
#pragma once
#include <stdint.h>
#include <stddef.h>
#include <string.h>
...
struct ImVector {
    ...
    void reserve(int new_cap) { Capacity = new_cap; }
    T* begin() { return Data; }
    T* end() { return Data + Size; }
};

struct ImGuiStyle { ImVec2 WindowPadding; float WindowRounding; float FrameRounding; ImVec4 Colors[55]; };
